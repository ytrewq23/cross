...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget _buildPortraitLayout(BuildContext context, AppLocalizations localizations) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        backgroundColor: _isOnline ? const Color(0xFF2A9D8F) : Colors.red,
          ...
          child: ListView(
            children: [
              ...
              FadeInLeft(
                duration: const Duration(milliseconds: 800),
                child: ListTile(
                  leading: const Icon(IconlyLight.info_circle, color: Color(0xFF2A9D8F)),
                  title: Text(
              ...
              FadeInLeft(
                duration: const Duration(milliseconds: 900),
                child: ListTile(
                  leading: const Icon(IconlyLight.setting, color: Color(0xFF2A9D8F)),
                  title: Text(
              ...
              FadeInLeft(
                ...
                child: ListTile(
                  leading: const Icon(IconlyLight.chat, color: Color(0xFF2A9D8F)),
                  title: Text(
  ...
  Widget _buildJobCard(BuildContext context, Map<String, dynamic> job,
      String jobId, AppLocalizations localizations) {
    return Card(
      child: Container(
        decoration: BoxDecoration(
